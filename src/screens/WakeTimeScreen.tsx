/**
 * "What time do you usually get out of bed?" screen. A hand-rolled wheel
 * picker (hour / minute / AM-PM), same spirit as LanguageSheet's hand-rolled
 * sheet — no native picker library. Each column is an Animated.ScrollView
 * that snaps to ITEM_H and fades rows by distance from the center via
 * scroll-position interpolation. Continue has no gating: a time is always
 * selected by default.
 */
